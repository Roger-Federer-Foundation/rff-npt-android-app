...
var locales = {
  "en": {
    ...
    "project": {
      ...
      "description": "",
      "image": "",
      "credit": "Developed by [Penreach](https://penreach.co.za/) with support from the [Roger Federer Foundation](https://www.rogerfedererfoundation.org/). Produced by [Electric Book Works](https://electricbookworks.com)."
    },
    "nav": {
      "home": "Home",
      "menu": "Menu",
  ...
  "fr": {
    ...
    "project": {
      ...
      "email": "",
      "name": "",
      "description": "Livres créés avec le flux de travail Electric Book",
      "image": "",
      "credit": "Construit avec [l'Electric Book](http://electricbook.works)"
    },
    "nav": {
      "home": "Accueil",
    ...
    "search": {
      ...
      "placeholder-searching": "Recherche...",
      "search-results": "Résultats de la recherche",
      "results-for-singular": "résultat trouvé pour",
      "results-for-plural": "résultats trouvés pour",
      "results-for-none": "Aucun résultat trouvé pour",
      "jump-to-first": "Aller au premier résultat ↓",
      "notice": ""
    },
    "contact": {
      "subject-line": "Enquête",
      "placeholder": {
        "name": "Nom",
    ...
    "questions": {
      "check-answers-button": "Vérifier mes réponses",
      "feedback-correct": "Correct!",
      "feedback-incorrect": "Incorrect",
    ...
    "annotator": {
      "show-sidebar-tooltip-title": "Ouvrir l'outil d'annotation",
...
! function(a, b, c) {
  ...
  var c = function() {
      ...
      return _createClass(c, [{
              ...
              var j = function() {
                ...
                if (d(g.node)) {
                  ...
                  if (a.value = k + l, a.nodes.forEach(function(b, c) {
                    ...
                    }), c -= j, e(g.node.previousSibling, g.start), !(c > g.end)) return {
                    v: !1
                  };
                  b = g.end
                }
        ...
        key: "iterator",
        get: function() {
          return this._iterator || (this._iterator = new d(this.ctx, this.opt.iframes, this.opt.exclude)), this._iterator
        }
      }]), c
    }(),
    d = function() {
      ...
      return _createClass(a, [{
        ...
        value: function() {
          var a = void 0,
            b = [];
          return a = "undefined" != typeof this.ctx && this.ctx ? NodeList.prototype.isPrototypeOf(this.ctx) ? Array.prototype.slice.call(this.ctx) : Array.isArray(this.ctx) ? this.ctx : [this.ctx] : [], a.forEach(function(a) {
        ...
        value: function(a, b, c, d, e) {
          for (var f = this, g = this.createIterator(b, a, d), h = [], i = void 0, j = void 0, k = function() {
              var a = f.getIteratorNode(g);
              return j = a.prevNode, i = a.node
            }; k();) this.iframes && this.forEachIframe(b, function(a) {
...
function ebCheckDeviceForVideoFiles() {
  ...
  window.resolveLocalFileSystemURL(
    ...
    function success(details) {
      console.log("Found file " + filelist[0]);
      console.log(details);
